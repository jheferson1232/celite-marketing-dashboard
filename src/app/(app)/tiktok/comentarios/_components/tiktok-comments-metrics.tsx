...
import type { TikTokCommentDashboardMetrics } from "@/lib/services/tiktok/comments/types"
...
export function TikTokCommentsMetrics({
  metrics,
  loading,
}: {
  metrics: TikTokCommentDashboardMetrics | undefined
  loading: boolean
}) {
  if (loading) {
    return (
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
      ...
      <MetricCard
        ...
        value={metrics?.monitoredAds ?? 0}
        hint="Ads ENABLE monitoreados"
