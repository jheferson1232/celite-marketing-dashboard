...
import {
  archiveMetaCampaignAction,
  listArchivedMetaCampaignsAction,
  unarchiveMetaCampaignAction,
} from "../../_actions/archived-campaigns"

export function useMetaArchivedCampaigns() {
  ...
  const archivedQuery = useQuery({
    queryKey: ["meta-archived-campaigns"],
    queryFn: () => runServerAction(listArchivedMetaCampaignsAction()),
  })
  ...
  const invalidate = () =>
    queryClient.invalidateQueries({ queryKey: ["meta-archived-campaigns"] })
  ...
  const unarchiveMutation = useMutation({
    mutationFn: (campaignId: string) =>
      runServerAction(unarchiveMetaCampaignAction(campaignId)),
    onSuccess: async () => {
      setFeedback({
        type: "success",
