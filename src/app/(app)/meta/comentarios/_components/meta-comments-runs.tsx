...
import { META_COMMENT_TRIGGER_LABEL } from "@/lib/services/meta/comments/constants"
import type { MetaCommentAgentRunSummary } from "@/lib/services/meta/comments/types"
...
export function MetaCommentsRuns({
  runs,
  loading,
}: {
  runs: MetaCommentAgentRunSummary[] | undefined
  loading: boolean
}) {
  return (
