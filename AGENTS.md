...
- Cron cada 2 h (GitHub Actions → `meta-hourly-report.ts`): resumen campañas + Telegram si conjunto ≥10k COP sin compras o campaña ≥30k sin compras. Botón «Enviar a Telegram» = mismo informe manual.
