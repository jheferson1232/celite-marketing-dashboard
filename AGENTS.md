...
- Cron horario (GitHub Actions → `meta-hourly-report.ts`): resumen campañas + Telegram si conjunto/campaña **ON** cumple ≥10k/≥30k COP sin compras. Botón «Enviar a Telegram» = mismo informe manual.
